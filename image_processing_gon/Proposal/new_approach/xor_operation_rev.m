function [ r_enc_dup ] = xor_operation_rev( r_enc ,xlog,ylog)
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
% r_enc =confusion_impl_rev2( r_enc,ylog(1));
r_enc = r_enc.*2;
m1 = zeros(size(r_enc));
m1(r_enc<0) = 1;
...
% r_enc_dup = vignere_rev(r_enc_dup,xlog);
% r_enc_dup = vignere_rev(r_enc_dup);
