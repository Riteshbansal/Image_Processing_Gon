...
% r_enc1 =  xor_operation(r_enc,xlog,ylog);
% g_enc1 =  xor_operation(g_enc,xlog,ylog);
% b_enc1 =  xor_operation(b_enc,xlog,ylog);
...
% r_enc_2 =  xor_operation(r_enc_2,xlog,ylog);
% g_enc_2 =  xor_operation(g_enc_2,xlog,ylog);
% b_enc_2 =  xor_operation(b_enc_2,xlog,ylog);
...
% r_enc2 =  xor_operation_rev(r_enc1,xlog,ylog);
% g_enc2 =  xor_operation_rev(g_enc1,xlog,ylog);
% b_enc2 =  xor_operation_rev(b_enc1,xlog,ylog);
...
enc_image = (im2uint8(mat2gray(img_enc)));
...
subplot(2,2,4),imshow(mat2gray(img_enc));
