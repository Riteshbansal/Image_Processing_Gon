...
for i = 1:16:r-16+1
    for j = 1:16:c-16+1
        ...
        linker = encrypt_dwt(matrix_gen,val);
        val = linker(16,16);
...
res = NPCR_and_UACI(floor(abs(uint8(new_mat))),floor(abs(uint8(new_mat_2))),1,255);
