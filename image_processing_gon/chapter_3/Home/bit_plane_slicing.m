...
subplot(3,3,2),imshow(im2uint8(im_1)),title('Bit plane 0');
subplot(3,3,3),imshow(im2uint8(im_2)),title('Bit plane 1');
subplot(3,3,4),imshow(im2uint8(im_3)),title('Bit plane 2');
subplot(3,3,5),imshow(im2uint8(im_4)),title('Bit plane 3');
subplot(3,3,6),imshow(im2uint8(im_5)),title('Bit plane 4');
subplot(3,3,7),imshow(im2uint8(im_6)),title('Bit plane 5');
subplot(3,3,8),imshow(im2uint8(im_7)),title('Bit plane 6');
subplot(3,3,9),imshow(im2uint8(im_8)),title('Bit plane 7');
