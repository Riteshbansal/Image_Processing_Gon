...
clearvars -except im R_Dec R_enc R_enc2
fontSize = 20;
...
NPCR_and_UACI( R_enc, R_Dec, 1, 255 );

figure;
subplot(2,2,1),imshow(mat2gray(im)),title('Orignal image');
...
subplot(2,2,3),imshow(mat2gray(R_enc)),title('Encrypted image');
[r1,g1,b1] = three_3d_im(R_enc);
subplot(2,2,4),scatter3(r1,g1,b1,3),title('Histogram Encrypted');
xlabel('R', 'FontSize', fontSize);
ylabel('G', 'FontSize', fontSize);
zlabel('B', 'FontSize', fontSize);
% 
